<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white sm:rounded-lg outline outline-1 outline-offset-4 outline-gray-300 mb-12">
                <div class="max-w-xl">
            ...
            <div class="p-4 sm:p-8 bg-white sm:rounded-lg outline outline-1 outline-offset-4 outline-gray-300" style="margin-top: 50px;">
                <div class="max-w-xl">
