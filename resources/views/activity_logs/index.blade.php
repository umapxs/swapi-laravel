                    ...
                    <div>
                        ...
                        <div class="w-full mb-4 justify-center block lg:flex lg:space-x-8">
                            <div class="mb-4 lg:w-3/6 lg:mx-1">
                                <input wire:model="search" wire:model.debounce.300ms="search" type="search" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Search Logs...">
                            </div>
                            <div class="mb-4">
                                ...
                                <tbody>
                                    @foreach($logs as $log)
                                        <tr>
                                            ...
                                            <td class="border px-4 py-2">{{ $log->browser }}</td>
                                            <td class="border px-4 py-2">{{ $log->device }}</td>
